...
public class stepdef {
	...
	@When("Suba attends class")
	public void suba_attends_class() {
	    // Write code here that turns the phrase above into concrete actions
		 System.out.println("check more outcomes");
   ...
   @When("I enter Username ass {string} and Password as {string}")
   public void i_enter_Username_ass_and_Password_as(String name, String address) {
       // Write code here that turns the phrase above into concrete actions
      System.out.println("string value is"+name+address);
   }
